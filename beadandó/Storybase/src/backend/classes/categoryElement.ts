...
//         this.sections = [CategoryElement.CreateSection("General description", "", false, sectionDescription)];
//     }
...
//             character.sections.push(CategoryElement.CreateSection(sectionTitle, "", false, sections[sectionTitle as keyof typeof sections]));
//         }
...
//         };
//         for (var sectionTitle in sections){
//             creature.sections.push(CategoryElement.CreateSection(sectionTitle, "", false, sections[sectionTitle as keyof typeof sections]));
//         }
...
//         };
//         for (var sectionTitle in sections){
//             location.sections.push(CategoryElement.CreateSection(sectionTitle, "", false, sections[sectionTitle as keyof typeof sections]));
//         }

//         return location;
//     }

//     private static CreateSection(title : string, content : string, userDefined : boolean, sectionDescription : string){
//         return {
//             title: title,
//             content: content,
...
//     private CreateCharacterPrompt(question : string){
...
//         this.sections.push(CategoryElement.CreateSection(question, "", false, promptText));
//     }

//     private AddCustomSection(){
//         this.sections.push(CategoryElement.CreateSection("Custom Section", "", true, "Give the section a name or enter a question, then write the details here!"));
//     }
// }
