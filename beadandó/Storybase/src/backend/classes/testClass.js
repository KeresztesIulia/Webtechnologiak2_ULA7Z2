class Section{
    constructor(title, userDefined, sectionDescription){
        this.title = title;
        this.content = "";
    ...
    CreateCharacterPrompt(question)
    {
    ...
    CreateCustomSection(){
        ...
        return Section.constructor("Custom section", "", true, desc);
    }
}

class CategoryElement{
    constructor(categoryName, name, user){
    ...
    static CreateCharacter(user) {
        var character = new CategoryElement("character", "Unnamed Character", user);
        ...
        for (var sectionTitle in sections){
            character.sections.push(new Section(sectionTitle, "", false, sections[sectionTitle]));
        }
    ...
    static CreateCreature(user){
        var creature = new CategoryElement("creature", "Unnamed Creature", user);
        ...
        for (var sectionTitle in sections){
            creature.sections.push(new Section(sectionTitle, "", false, sections[sectionTitle]));
        }
    ...
    static CreateLocation(user){
        var location = new CategoryElement("location", "Unnamed Location", user);
        ...
        for (var sectionTitle in sections){
            location.sections.push(new Section(sectionTitle, "", false, sections[sectionTitle]));
        }
